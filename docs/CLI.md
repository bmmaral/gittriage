...
| `report` | Render markdown or JSON from the current inventory (plan recomputed in-process); its JSON-friendly building blocks also feed the CI regression-dashboard artifact workflow and benchmark summaries |
